...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div class="row"  style="margin-top:20px; margin-left:250px; width:1500px" >
        ...
        <div class="col-md-4">   <!-- This means it uses 33% of the row, col-md-5 is 42% -->
            <h3>About Us</h3>
            <img src="Resources/nbapic.jpg" style="width:200px; height:150px" />
            <br />
            <br />
            <div style ="color:red;">
            <p>
    ...
    <!--<div style="color:lawngreen; width:1920px; height:500px" >
                <a class ="btn btn-default" style="color:lawngreen; position:absolute; margin-left:1785px; margin-top:30px" href="https://www.facebook.com/pages/Humes-Landscape-Service/187534687944624">f</a>
